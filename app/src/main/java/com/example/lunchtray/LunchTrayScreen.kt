...
enum class LunchTrayScreen(@StringRes val title: Int){
    ...
    EntreeMenu(title = R.string.app_name),
    SlideDishMenu(title = R.string.app_name),
    AccompanimentMenu(title = R.string.app_name),
    Checkout(title = R.string.app_name)
}
        ...
        NavHost(
            ...
            composable(route = LunchTrayScreen.EntreeMenu.name){
                EntreeMenuScreen(
                    ...
                    onNextButtonClicked = {
                                          navController.navigate(LunchTrayScreen.SlideDishMenu.name)
                    },
